...
public:
     ...
     * @return 是否成功
     */
    static bool exportDetectionResult(const DetectionResult &result,
     ...
     * @brief 导出分类结果
     */
    static bool exportClassificationResult(const ClassificationResultList &result,
                                            const ExportMetadata &metadata,
                                            const QString &filePath,
                                            Format format = Format::JSON);
     ...
     * @brief 导出关键点检测结果
     */
    static bool exportKeypointResult(const KeypointResult &result,
                                      const ExportMetadata &metadata,
                                      const QString &filePath,
                                      Format format = Format::JSON);
     ...
     * @return 是否成功
     */
    static bool exportBatchResults(const QVector<QPair<QString, DetectionResult>> &results,
...
private:
    ...
    static QJsonObject detectionToJson(const Detection &det);
    ...
    static QString detectionToCsvRow(const Detection &det, const ExportMetadata &metadata);
