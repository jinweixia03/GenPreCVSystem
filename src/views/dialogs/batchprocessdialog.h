...
private:
    ...
    // 结果存储（检测/分割）
    QVector<QPair<QString, Utils::DetectionResult>> m_detectionResults;
    // 分类结果存储
    QVector<QPair<QString, Utils::ClassificationResultList>> m_classificationResults;
    // 关键点结果存储
    QVector<QPair<QString, Utils::KeypointResult>> m_keypointResults;
