...
public:
     ...
     */
    void setResult(const QString &imagePath, const Utils::DetectionResult &result, bool showLabels = true);
    void setResult(const QPixmap &pixmap, const Utils::DetectionResult &result, bool showLabels = true);
     ...
     * @param showLabels 是否显示标签
     */
    void setSegmentationResult(const QPixmap &pixmap, const Utils::DetectionResult &result,
     ...
     * @param showLabels 是否显示标签
     */
    void setKeypointResult(const QPixmap &pixmap, const Utils::KeypointResult &result,
...
private:
    ...
    DetectionOverlay convertToOverlay(const Utils::Detection &det, int index);
    void drawKeypointSkeleton(QPainter &painter, const Utils::KeypointDetection &kp, const QColor &color);
    ...
    Utils::DetectionResult m_currentResult;
    Utils::ClassificationResultList m_classificationResult;
    Utils::KeypointResult m_keypointResult;
